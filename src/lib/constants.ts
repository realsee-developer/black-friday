...
export const RETAIL_PARTNERS: RetailPartner[] = [
  {
    ...
    url: "https://www.bhphotovideo.com/c/search?q=realsee%20galois&sts=ma",
    themeColor: {
      from: "#DC143C",
      to: "#B71C1C",
      hover: "#FF1744",
  ...
  },
  {
    ...
    url: "https://www.adorama.com/l/?searchinfo=realsee%20galois",
    themeColor: {
      from: "#FDB813",
      to: "#F57C00",
      hover: "#FFD54F",
  ...
  },
  {
    ...
    url: "https://www.robotshop.com/search?q=realsee%20galois",
    themeColor: {
      from: "#00A0E3",
      to: "#0277BD",
      hover: "#29B6F6",
...
export const DISTRIBUTION_FEATURES: DistributionFeature[] = [
  ...
  },
  {
    ...
    description: "3D Tour, Photos, Floorplan, Point Cloud and more",
