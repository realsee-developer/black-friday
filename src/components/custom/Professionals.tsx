...
export function Professionals() {
  ...
  const list = useMemo(() => {
    const filtered = (professionalsData as Professional[])
  ...
  return (
    <section 
      className="relative overflow-visible bg-gradient-to-b from-cyber-gray-900 via-cyber-gray-900/95 to-cyber-gray-800 py-12 sm:py-16 md:py-20 lg:py-28"
      role="region"
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6">
            ...
            >
              <div className="relative mb-6 h-28 w-28 overflow-hidden rounded-2xl border border-white/40 bg-cyber-gray-800 shadow-lg shadow-black/30 transition-transform duration-500 group-hover:scale-[1.05]">
                <div className="relative h-full w-full">
                  <Image
                    src={`/professional/${p.slug || p.id}.jpg`}
        ...
        <div className="relative hidden md:block pb-12 min-h-[600px]">
          {/* Navigation arrows */}
          <button
