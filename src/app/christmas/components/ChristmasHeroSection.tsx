    ...
    >
      ...
      <div className="absolute inset-0 w-full h-full">
        <ResponsiveBackgroundImage
          ...
          priority
        />
        {/* Christmas Red Overlay */}
        <div className="absolute inset-0 bg-gradient-to-b from-christmas-red/10 via-transparent to-[#1a0a0a]/80" />
      </div>
      ...
      <div className="absolute inset-0">
        ...
        {/* Animated gradient orbs - Christmas themed */}
        <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-christmas-red/10 blur-[140px] animate-pulse" />
        <div className="absolute bottom-1/4 right-1/4 w-80 h-80 rounded-full bg-christmas-gold/8 blur-[130px] animate-pulse animation-delay-1000" />
      ...
      <div className="absolute inset-0 flex justify-center">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full pt-24 pb-8 sm:pt-0 sm:pb-0 sm:h-full sm:flex sm:items-center md:pt-16">
          <div className="flex flex-col items-center sm:items-start justify-start text-center sm:text-left space-y-5 sm:space-y-4 md:space-y-5 max-w-6xl mx-auto sm:mx-0 sm:max-w-md md:max-w-lg lg:max-w-2xl w-full">
            {/* Promo badge */}
            <div
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-christmas-red/20 border border-christmas-red/30 backdrop-blur-sm"
              style={getParallaxStyle(0.5)}
            >
              <span className="text-christmas-gold text-sm font-semibold">
            ...
            >
              <h1 className="text-3xl sm:text-2xl md:text-3xl lg:text-5xl xl:text-6xl font-bold leading-tight tracking-tight bg-gradient-to-r from-christmas-red via-christmas-gold to-christmas-red bg-clip-text text-transparent">
              ...
              {CHRISTMAS_HERO_CONFIG.ctaButtons.map((btn) => (
                <a
                  ...
                  className={`group relative px-10 sm:px-8 md:px-10 lg:px-16 py-4 sm:py-3.5 md:py-4 lg:py-6 text-lg sm:text-base md:text-lg lg:text-2xl font-bold rounded-xl transition-all duration-300 hover:scale-105 active:scale-100 min-h-[52px] sm:min-h-[48px] md:min-h-[52px] flex items-center justify-center touch-none ${
                    btn.primary
                      ? "bg-gradient-to-r from-christmas-red to-christmas-red-dark text-white shadow-lg shadow-christmas-red/30 hover:shadow-2xl hover:shadow-christmas-red/50"
                      : "bg-white/10 text-white border border-christmas-gold/30 hover:bg-white/20"
                  }`}
                >
                  {btn.primary && (
                    <div className="absolute inset-0 rounded-xl bg-linear-to-r from-christmas-red to-christmas-gold opacity-0 group-hover:opacity-30 blur-xl transition-opacity duration-300 -z-10" />
                  )}
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce">
        <div className="w-6 h-10 rounded-full border-2 border-christmas-red/50 flex items-start justify-center p-2">
          <div className="w-1 h-2 rounded-full bg-christmas-red animate-pulse" />
        </div>
      </div>
    </section>
  );
